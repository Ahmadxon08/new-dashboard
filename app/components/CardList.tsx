    ...
    <div>
      ...
      <div className="flex flex-col gap-2 p-2">
        {list.map((item) => (
          <Card
            key={item.id}
            className="flex-row h-[100px] p-1.5 justify-between items-center gap-2"
          >
            <div className="h-12 w-12 rounded-sm relative overflow-hidden">
              <Image
                src={item.image}
                alt={item.title}
                fill
            ...
            <CardContent className="p-0 flex  gap-0.5 justify-start items-start flex-col">
              <CardTitle className="text-[14px]">{item.title}</CardTitle>
